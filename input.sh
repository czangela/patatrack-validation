...
GLOBALTAG="112X_mcRun3_2021_realistic_v10"
NUMEVENTS=200
...
TTBAR="/RelValTTbar_14TeV/CMSSW_11_2_0_pre7-PU_112X_mcRun3_2021_realistic_v8-v1/GEN-SIM-DIGI-RAW"
TTBAR_NUMEVENTS=100

# Z -> mumu sample, with 2021 "realistic" conditions, no pileup
ZMUMU="/RelValZMM_14/CMSSW_11_2_0_pre7-112X_mcRun3_2021_realistic_v8-v2/GEN-SIM-DIGI-RAW"
ZMUMU_NUMEVENTS=200

# Z -> ee sample, with 2021 "realistic" conditions, no pileup
ZEE="/RelValZEE_14/CMSSW_11_2_0_pre7-112X_mcRun3_2021_realistic_v8-v1/GEN-SIM-DIGI-RAW"
ZEE_NUMEVENTS=200
...
L1ACCEPT_GLOBALTAG="auto:run2_hlt_relval"
